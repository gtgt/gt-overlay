...
inherit check-reqs flag-o-matic toolchain-funcs eutils gnome2-utils mozconfig-gt multilib pax-utils fdo-mime autotools python virtualx nsplugins mozlinguas
...
IUSE="bindist +crashreporter +ipc +minimal pgo +gtk2 qt selinux system-sqlite +webm"
...
src_configure() {
	...
	mozconfig_annotate '' --with-system-ffi
