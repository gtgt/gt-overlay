...
# $Header: /var/cvsroot/gentoo-x86/dev-java/sun-jdk/sun-jdk-1.7.0.ebuild,v 1.3 2011/06/18 11:49:39 hwoarang Exp $
...
URL_BASE="http://download.oracle.com/otn-pub/java/jdk/7"
...
KEYWORDS=""
RESTRICT="strip"
IUSE="X alsa derby examples nsplugin odbc"
...
pkg_postinst() {
	...
	if use x86 && use nsplugin; then
		...
		elog "For more info see https://jdk7.dev.java.net/plugin2/"
		elog
	fi
