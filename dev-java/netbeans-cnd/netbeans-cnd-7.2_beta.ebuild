...
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/41A2A50A59225CAB20940E88A67B8BADFC0F45AF-open-fortran-parser-0.7.1.2.zip"
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/41A2A50A59225CAB20940E88A67B8BADFC0F45AF-open-fortran-parser-0.7.1.2.zip cnd.modelimpl/external/open-fortran-parser-0.7.1.2.zip || die
	popd >/dev/null || die
}
