...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2012-07-02_09-07-50/zip/netbeans-trunk-nightly-201207020907-src.zip"
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/722C8EC88732F63EC7DF1D641F72C2851EDE95FD-libs.oracle.cloud-ext.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/26F461B41CF3E9070A76E44ACDD1FD8560FB1E25-javaee5.jar libs.oracle.cloud/external/javaee5.jar || die
	...
	ln -s "${DISTDIR}"/722C8EC88732F63EC7DF1D641F72C2851EDE95FD-libs.oracle.cloud-ext.jar libs.oracle.cloud/external/libs.oracle.cloud-ext.jar || die
